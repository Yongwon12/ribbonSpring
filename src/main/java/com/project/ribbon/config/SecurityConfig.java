...
public class SecurityConfig {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
                ...
                .and()
                .csrf().ignoringRequestMatchers("/ws/chat")
                .and()
                ...
                .requestMatchers("/ribbon/admin/paymentinfo").hasRole("ADMIN")
                .requestMatchers("/ribbon/admin/paymentlogin").hasRole("ADMIN")
                .requestMatchers("/ribbon/admin/inqueryPaymentInfo").hasRole("ADMIN")
...
//                .requestMatchers("/ws/chat").hasAnyRole("USER","INSTRUCTOR")
                ...
                .requestMatchers("/chat/post/**").hasAnyRole("USER","INSTRUCTOR")
